...
<body>
	<!--header-->
@include('front-end.includess.header')
	   @yield('body')
		<!---footer--->
@include('front-end.includess.footer')
					<!--copy-->
					<div class="copy-section">
						<div class="container">
							<div class="copy-left">
								<p>&copy; 2019 sotota electronics . All rights reserved | Devloped by <a href="http://w3layouts.com">Mr.Kishor Laskar</a></p>
							</div>
