						...
						<div class="product-agileinfo-grids w3l">
							<div class="col-md-3 product-agileinfo-grid">
								...
								<div class="brand-w3l">
									...
									<li class="active"><a href="{{route('product-brand',['id'=>$brand->id])}}" class="act">{{$brand->brand_name}}</a></li>	
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
												@foreach($catagoreyProducts as $catagoreyProduct)
														...
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset($catagoreyProduct->product_image)}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
											<img  src="{{asset($catagoreyProduct->product_image)}}" class="img-responsive"  alt="">
																	</div>			
														...
														<div class="women">
															<h6><a href="single.html">{{$catagoreyProduct->product_name}}</a></h6>
															<span class="size">{{$catagoreyProduct->product_size}}</span>
															<p >Tk.<em class="item_price">{{$catagoreyProduct->product_price}}</em></p>
											...
											<div class="product-tab1">
												...
												<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
													...
													<div class="women">
														<h6><a href="single.html">{{$catagoreyProduct->product_name}}</a></h6>
														<span class="size">{{$catagoreyProduct->product_size}}</span>
														<p>{{$catagoreyProduct->product_short_description}} <p>
														<p ><em class="item_price">{{$catagoreyProduct->product_price}}</em></p>
														<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
													</div>
												</div>
												@endforeach
